(function() {
	...
	function DataSvc() {
		var storageId = 'ionExpenseTracker.0.1';
		...
		function get() {
			return JSON.parse(localStorage.getItem(storageId) || defaultObj, function (key, value) {
				return key === 'date' ? new Date(value) : value;
			});
		}

		function put(expenseObj) {
			localStorage.setItem(storageId, JSON.stringify(expenseObj, function (key, value) {
