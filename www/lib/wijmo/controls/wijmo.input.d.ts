    ...
    */
    class ColorPicker extends Control {
        ...
        */
        constructor(element: any, options?: any);
        /**
        * Gets or sets whether the @see:ColorPicker should allow users
        * to edit the color's alpha channel (transparency).
        */
        public showAlphaChannel : boolean;
        /**
        * Gets or sets whether the @see:ColorPicker should show a string representation
    ...
    */
    class InputDate extends DropDown {
        ...
        */
        ...
        /**
        * Gets or sets a mask to be used while editing.
        *
...
declare module wijmo.input {
    ...
    */
    class InputTime extends ComboBox {
        ...
        *
        * If specified, the mask should be compatible with the value of
        * the @see:format property. For example, the mask '99:99 >LL' can
        * be used for entering short times (format 't').
        */
        public mask : string;
        /**
...
declare module wijmo.input {
    /**
    * The @see:InputMask control provides masked input.
    *
    * The control prevents users from accidentally entering invalid data and
    * saves time by skipping over literals as the user types.
    *
    ...
    */
    class InputColor extends DropDown {
        ...
        */
        public text : string;
        /**
        * Gets or sets whether the control value must be a color or whether it
        * can be set to null (by deleting the content of the control).
        */
        public required : boolean;
        /**
